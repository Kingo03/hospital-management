	...
	include('assets/inc/config.php');
		if(isset($_POST['update_profile']))
		{
           ...
           // $doc_pwd=sha1(md5($_POST['doc_pwd']));
			...
			$query="UPDATE his_patients SET pat_fname=?, pat_lname=?,  pat_email=?, pat_pic=? WHERE pat_id = ?";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ssssi', $pat_fname, $pat_lname, $pat_email, $pat_pic, $pat_id);
			$stmt->execute();
			/*
        ...
        if(isset($_POST['update_pwd']))
		{
            ...
            $doc_pwd=sha1(md5($_POST['pat_pwd']));//double encrypt 
            
            //sql to insert captured values
			$query="UPDATE his_patients SET pat_pwd =? WHERE pat_number = ?";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('si', $pat_pwd, $pat_number);
			$stmt->execute();
			/*
			*Use Sweet Alerts Instead Of This Fucked Up Javascript Alerts
			*echo"<script>alert('Successfully Created Account Proceed To Log In ');</script>";
                            ...
                            <div class="col-lg-4 col-xl-4">
                                <div class="card-box text-center">
                                    ...
                                    <div class="text-centre mt-3">
                                        ...
                                        <p class="text-muted mb-2 font-13"><strong>Patient's Full Name :</strong> <span class="ml-2"><?php echo $row->pat_fname;?> <?php echo $row->pat_lname;?></span></p>
                                        <!-- <p class="text-muted mb-2 font-13"><strong>Employee Department :</strong> <span class="ml-2"> echo $row->pat_dept;?></span></p> -->
                                        <p class="text-muted mb-2 font-13"><strong>Patient's Number :</strong> <span class="ml-2"><?php echo $row->pat_number;?></span></p>
                                        <p class="text-muted mb-2 font-13"><strong>Patient's Email :</strong> <span class="ml-2"><?php echo $row->pat_email;?></span></p>
