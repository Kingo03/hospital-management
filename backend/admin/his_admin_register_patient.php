...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_patient']))
		{
            ...
            $pat_pwd = password_hash($_POST['pat_pwd'], PASSWORD_DEFAULT);
            //sql to insert captured values
			$query="insert into his_patients (pat_fname, pat_ailment, pat_lname, pat_age, pat_dob, pat_number, pat_phone, pat_type, pat_addr, pat_pwd) values(?,?,?,?,?,?,?,?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ssssssssss', $pat_fname, $pat_ailment, $pat_lname, $pat_age, $pat_dob, $pat_number, $pat_phone, $pat_type, $pat_addr, $pat_pwd);
			$stmt->execute();
			/*
