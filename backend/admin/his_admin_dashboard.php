        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="text-right">
                    <?php
                        /* 
                         * code for summing up the number of appointments
                         */ 
                        $result = "SELECT count(*) FROM appointments";
                        $stmt = $mysqli->prepare($result);
                        $stmt->execute();
                        $stmt->bind_result($appointments);  // Use $appointments to hold the count value
                        $stmt->fetch();
                        $stmt->close();
                    ?>
