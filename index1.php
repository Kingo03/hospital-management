    ...
    <header class = "header bg-blue">
        <nav class = "navbar bg-blue">
            <div class = "container flex">
                ...
                <img src="images/logoDOC.jpg" alt="site logo" height="60" width="40" style="border-radius: 50%;">
                <!-- <img src = "images\logoDOC.jpg" alt = "site logo" height ="40" width = "40"> -->
                </a>
                ...
                <div class = "navbar-collapse bg-white">
                    ...
                    <ul class = "navbar-nav">
                        ...
                        <li class = "nav-item">
                            <a href = "backend/admin/index.php" class = "nav-link">Admin Login</a>
                        </li>
                        <li class = "nav-item">
                            <a href = "backend/doc/index.php" class = "nav-link">Doctor's Login</a>
                        </li>
                        <li class = "nav-item">
                            <a href = "backend/patient/index.php" class = "nav-link">Patient's Login</a>
                        </li>
                        <li class = "nav-item">
            ...
            <div class = "container grid">
                <div class = "header-inner-left">
                    ...
                    <div class = "btn-group">
                        ...
                        <a href = "backend/patient/process_appointment.php" class = "btn btn-light-blue">Book for Appiontment</a>
                    </div>
                </div>
